...
export function rulesBlock(): string {
  return [
    ...
    '',
    '`transcribe` and `summarize` return a job id: poll `job_status`, a few minutes apart. When',
    'it reports `unnamedSpeakers`, ask who they are and save it with `annotate`; names outlive re-runs.',
    '',
